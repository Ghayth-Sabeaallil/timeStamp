(() => {
          ...
          function y() {
            ...
            function V(t, e) {
              ...
              return (
                (function (t, e) {
                  var n = v[t];
                  (A[t] = e), (T[t] = t === l ? Math.abs(e) : p(e >= 0 ? e : n - p(e, n), n));
                })(e, B(t, h[e])),
                A[e] !== n
              );
            }
            ...
            function C(n) {
              ...
              W() ? ((O = M()), (g = N(m.target))) : R(n),
                (r = h[e]),
                q(_(Date.now())) || ((t = setInterval(U, r)), (P = !0), (x = !1));
            }
            function M() {
            ...
            function $() {
              var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : _(Date.now()),
                e = o > 0 ? t - O : O - t,
                n = {};
              return (
                (n[u] = V(e, u)),
            ...
            function R(t) {
              var n;
              (e = (function (t) {
                if (((e = t = "string" == typeof t ? t : c), !(d.indexOf(e) >= 0)))
  ...
  (() => {
    ...
    document.querySelector(".increase-time").addEventListener("click", function () {
      (r = parseInt(e.textContent)), r < 60 && ((r += 5), (e.textContent = `${r}`)), console.log(r);
    }),
      document.querySelector(".decrease-time").addEventListener("click", function () {
        (r = parseInt(e.textContent)), r > 5 && ((r -= 5), (e.textContent = `${r}`)), console.log(r);
      }),
      document.querySelector(".start-button").addEventListener("click", function () {
        t.default.start({ countdown: !0, startValues: { minutes: r }, target: { seconds: 0 } }),
